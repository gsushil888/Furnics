...
const footerData = [
    ...
    },
    {
        ...
        title: 'Contact Us', data: [
            '+9184199084', 'gsushil12@gmail.com', 'Wadala-(East)',
        ]
    }
]
const Footer = () => {
    return (
        <View style={{ marginTop: 100 }}>
            <View style={{ flexDirection: 'column', gap: 30, padding: 10 }}>
                <View>

                    <Image style={{marginBottom:20}} source={require('../assets/images/main-logo.png')} />
